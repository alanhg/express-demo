...
# 预装插件
curl https://raw.githubusercontent.com/alanhg/express-demo/master/lib/code-server/model/MS-CEINTL.vscode-language-pack-zh-hans-1.72.10121008.vsix > ./ms-ceintl.vscode-language-pack-zh-hans.vsix
