...
const remoteCodeServerPort = 36001;
...
curl -sSo $HOME/.term/code-server/code-server-install-v1.0.sh https://raw.githubusercontent.com/alanhg/express-demo/master/lib/code-server/model/code-server-install.sh
fi
...
`
  ...
  // 停止服务
  get stopService() {
    return [...this.initEnv, '/usr/bin/supervisorctl -c $ORCA_CODE_SERVER_DIR/supervisord-conf/supervisord.conf stop code-server'];
  },
