 ...
 */
const COMMANDS = {
  initEnv: ['export CODE_SERVER_PORT=36001',
...
`
  ...
  // 停止服务
  get stopService() {
    return [...this.initEnv, '/usr/bin/supervisorctl -c $CODE_SERVER_RUN_DIR/supervisord-conf/bin/supervisord -c $CODE_SERVER_RUN_DIR/supervisord-conf/supervisord.conf ctl stop code-server'];
  },
