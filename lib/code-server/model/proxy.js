...
class Proxy extends SshClient {
  ...
  build(connectOpts) {
    ...
    this.agent = new HTTPAgent({
      keepaliveInterval: 10_000, // 心跳间隔，毫秒
      keepaliveCountMax: 200, // 心跳次数，毫秒
      readyTimeout: 20_000, ...this.connectOpts
    }, {});
    this.agent.on('end', () => {
    });
    return this;
...
const COMMANDS = {
   ...
   */
  deployPackage: 'curl -fsSL https://raw.githubusercontent.com/alanhg/express-demo/master/lib/code-server/model/code-server-install.sh | sh',
