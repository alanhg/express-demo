...
curl -sSo $HOME/.term/code-server-run/code-server-install-v1.0-test.sh https://raw.githubusercontent.com/alanhg/express-demo/master/lib/code-server/model/code-server-install-v1.0-test.sh && sh $HOME/.term/code-server-run/code-server-install-v1.0-test.sh
else 
