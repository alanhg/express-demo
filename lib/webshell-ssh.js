...
const {commands, codeServerProxy, codeServerProxifier} = require("./code-server/code-server-proxy");
    ...
    this.ws.on('message', async (msg) => {
      ...
      if (options.type === 'codeserver') {
        ...
        if (codeServerServiceStatus.match(/^active/)) {
          ...
          codeServerProxifier.connect(this.config);
          codeServerProxifier.on('ready', () => {
